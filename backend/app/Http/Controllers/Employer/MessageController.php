...
final class MessageController extends Controller
{
    ...
    {
        // Reading the thread clears its unread messages, so the list has to be
        // loaded afterwards or the badge would linger for one more render.
    ...
    public function send(Request $request, string $uuid): RedirectResponse|JsonResponse
    {
        ...
        return to_route('employer.messages.show', $uuid);
    }
}

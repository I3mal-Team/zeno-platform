...
final class AboutViewModel
{
    ...
    {
        return [
            ['icon' => 'location', 'title' => 'القرب أولًا', 'body' => 'نؤمن أن أفضل الفرص غالبًا قريبة — نجعل المسافة ميزة لا عائقًا.', 'bg' => '#FDF1CC', 'fg' => '#8A6D12'],
    ...
    {
        return [
            ['year' => '2024', 'title' => 'انطلاق الفكرة', 'body' => 'بدأنا من ملاحظة بسيطة: الوظائف القريبة أصعب في الإيجاد مما ينبغي.', 'dot' => '#F7BE17', 'ring' => '#E7C24A'],
            ['year' => '2025', 'title' => 'إطلاق التطبيق', 'body' => 'أطلقنا النسخة الأولى في الرياض بخريطة تفاعلية وتواصل عبر واتساب.', 'dot' => '#F7BE17', 'ring' => '#E7C24A'],
            ['year' => '2025', 'title' => 'أول 1,000 منشأة', 'body' => 'انضمت آلاف المنشآت المحلية ونشرت أولى وظائفها عبر زينو.', 'dot' => '#2B2724', 'ring' => '#C9C4B9'],
            ['year' => '2026', 'title' => 'التوسّع الوطني', 'body' => 'نتوسّع إلى 15 مدينة سعودية مع لوحة تحكم ويب كاملة لأصحاب العمل.', 'dot' => '#2B2724', 'ring' => '#C9C4B9'],
        ];
    }
    ...
    {
        return [
            ['initial' => 'أ', 'name' => 'أحمد الشمري', 'role' => 'الرئيس التنفيذي', 'bg' => '#FDF1CC', 'fg' => '#8A6D12'],

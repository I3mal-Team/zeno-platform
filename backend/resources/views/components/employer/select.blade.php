...
<div>
  ...
  <select name="{{ $name }}" style="width:100%;height:50px;border:1px solid {{ $hasError ? '#B23232' : '#DCE3DD' }};border-radius:14px;background:#F7F9F7;padding:0 12px;font-family:inherit;font-size:15px;font-weight:700;color:#284C3D;outline:none;cursor:pointer">

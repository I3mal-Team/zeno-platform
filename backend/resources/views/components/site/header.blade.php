  ...
  <div style="max-width:1180px;margin:0 auto;padding:14px 26px;display:flex;align-items:center;justify-content:space-between;gap:20px">
    ...
    <div style="display:flex;align-items:center;gap:11px">
      @auth
        ...
        @else
          <a href="{{ route('dashboard') }}" class="lnk hide-sm" style="font-size:14.5px;font-weight:800;color:#2B2724;display:flex;align-items:center;gap:6px"><i class="iconsax" style="font-size:18px" icon-name="element-3"></i>لوحتي</a>

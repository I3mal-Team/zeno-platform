...
@if ($job->status->canTransitionTo(JobStatus::Closed))
  ...
  <div style="background:#fff;border:1px solid #EDEAE2;border-radius:20px;padding:22px;margin-top:16px;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
    <div style="flex:1;min-width:220px">
      <div style="font-size:16px;font-weight:800;color:#211F20">إغلاق الإعلان</div>
      <div style="font-size:13.5px;color:#8A857A;font-weight:600;margin-top:3px">يُخفي الإعلان نهائياً ويوقف استقبال الطلبات. لا يمكن التراجع.</div>
    </div>

...
@section('description', 'وُلدت AMS من فكرة بسيطة: أفضل وظيفة لك قد تكون على بُعد شارع واحد.')
...
<section style="max-width:1180px;margin:0 auto;padding:64px 26px 40px;text-align:center">
  ...
  <p style="font-size:18px;color:#5C6862;font-weight:500;line-height:1.75;margin:18px auto 0;max-width:640px">وُلدت AMS من فكرة بسيطة: أفضل وظيفة لك قد تكون على بُعد شارع واحد. نبني منصة توظيف محلية تجعل إيجاد عمل قريب أمرًا سهلًا وسريعًا وإنسانيًا.</p>
</section>
...
<section style="max-width:820px;margin:0 auto;padding:64px 26px 20px">
  <x-site.section-heading eyebrow="رحلتنا" title="محطات AMS"/>
...
<section style="max-width:1180px;margin:0 auto;padding:44px 26px 20px">
  <x-site.section-heading eyebrow="الفريق" title="من يقف خلف AMS"/>
...
<section style="max-width:1180px;margin:0 auto;padding:64px 26px 20px">
  <div style="background:#C9A24B;border-radius:30px;padding:52px 44px;text-align:center">
    ...
    <p style="font-size:17px;color:#5A4A16;font-weight:600;margin-top:12px">سواء كنت تبحث عن عمل أو عن موظفين — AMS معك.</p>

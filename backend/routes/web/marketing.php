...
use App\Http\Controllers\Site\Marketing\AccountDeletionController;
...
// Both must stay public and top-level: Play fetches them while signed out,
// and a deletion URL behind an auth gate is a rejection.
Route::get('privacy', PrivacyController::class)->name('privacy');
Route::get('delete-account', AccountDeletionController::class)->name('account.delete');
